...
tags: ["Productivity"]
catalog: {"kind":"app","id":"@ryu/quests","category":"Productivity","version":"0.1.14","official":true,"builtIn":true,"system":false,"preInstalled":false,"stability":"experimental","hidden":false,"surfaces":{"gateway":"none","core":"full","desktop":"full","island":"limited","mobile":"limited","extension":"none","web":"full","cli":"list"}}
---
...
## Refreshing and scratchpad drafts

Automatic task-list reads wait for the previous read to settle and pause while
the companion tab is hidden. Returning to the tab refreshes the list. Task
mutations still await their fresh list, and active work continues in its owning
service. A late initial scratchpad load cannot replace text you have started
typing; scratchpad saves still flush when the field loses focus or unmounts.
