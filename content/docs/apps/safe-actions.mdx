...
The Companion uses the Ryu App UI v1 root contract. Policies, Reviews, and Receipts are contributed
through the app manifest so Ryu owns the sidebar in hosted and standalone windows; the static
satellite keeps only its domain review and receipt panels.
