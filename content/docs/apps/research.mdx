...
tags: ["Research"]
catalog: {"kind":"app","id":"@ryu/research","category":"Research","version":"0.1.17","official":true,"builtIn":true,"system":false,"preInstalled":false,"stability":"experimental","hidden":false,"surfaces":{"gateway":"none","core":"full","desktop":"full","island":"full","mobile":"full","extension":"full","web":"full","cli":"full"}}
---
...
Oversized-history proposals bind the canonical campaign snapshot to RLM with a
`sha256:<64-hex>` digest. Research rejects a response with a different digest,
an out-of-campaign citation, or no successful recursive step before the proposal
can be consumed by an attempt.
