...
catalog: {"kind":"app","id":"@ryu/healing","category":"Developer Tools","version":"0.1.14","official":true,"builtIn":true,"system":false,"preInstalled":false,"stability":"experimental","hidden":false,"surfaces":{"gateway":"none","core":"full","desktop":"full","island":"full","mobile":"full","extension":"full","web":"full","cli":"full"}}
---
...
- **Self-Healing widget** - Self-Healing chat widget metadata is coming soon; no render tool is available yet.
