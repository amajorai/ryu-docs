...
A local-first video capture and ingest surface with a bundled editor preview. The out-of-process ryu-clips sidecar owns Core→Shadow recording and URL ingest; transcript-led analysis and vertical rendering are not connected yet.
