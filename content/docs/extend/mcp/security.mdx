...
The MCP (Model Context Protocol) server is a bridge with real reach. It can drive your node as fully as the token you give it allows, so treat it like any other credentialed client.
