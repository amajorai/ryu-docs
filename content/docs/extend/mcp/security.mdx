...
The local bridge still needs node access because it is controlling a particular Core instance; an
account session alone does not silently grant control of every node.
