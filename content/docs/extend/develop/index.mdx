...
<Cards>
  ...
  <DocCard href="/docs/extend/develop/sdk" title="SDK Reference" description="TypeScript SDK (defineAgent / defineWorkflow / defineTool / defineSkill), the client library, and the Rust SDK." />
  <DocCard href="/docs/extend/develop/ui-package" title="Design System" description="66+ components, 16 hooks, 30+ theme presets, and a full OKLCH token system for consistent UI across surfaces." />
