...
| Category | What | Guide |
|---|---|---|
| **Primitives** | The swappable building blocks — memory, RAG, sandboxes, voice, tools, gateway stages — one page each | [Primitives](/docs/primitives) |
| **Plugins vs Apps** | When to ship net-new capability logic vs a full surface on pre-built primitives | [Plugins vs Apps](/docs/develop/extensions/plugins-vs-apps) |
