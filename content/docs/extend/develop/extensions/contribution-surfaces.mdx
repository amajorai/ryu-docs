...
data and route names; the desktop owns authentication, the Apps shelf, layout, icons, focus
...
and signed-in identity. Switching identities uses a separate cache and cancels
obsolete reads; collapsing a sidebar section stops its own refresh timer.
