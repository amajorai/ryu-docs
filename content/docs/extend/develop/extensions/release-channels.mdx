...
later update follows that train instead of jumping to the latest release on another train.

<Callout type="info">
  This page documents release trains for Marketplace extensions and apps. For the Ryu desktop and
