...
See [Bundle Runnables with manifest.json](/docs/develop/extensions/plugin-json-manifest) and
[Plugin Runtime](/docs/develop/extensions/plugin-runtime).
...
`BUILTIN_MANIFESTS` (`apps/core/src/plugin_manifest/mod.rs`) that pulls the app's own manifest
...
See [Author a Ryu App](/docs/develop/extensions/ryu-apps) for the widget-authoring path and
[Capability Broker](/docs/develop/extensions/capability-broker) for the swap seam.
...
| **Ryu App** (widget) | An in-chat interactive widget (OpenAI-Apps-SDK compatible) — see [Ryu Apps](/docs/desktop/user-guide/apps) |
...
<Cards>
  <DocCard href="/docs/develop/extensions/plugin-json-manifest" title="Plugins & manifest.json" description="Declare Runnables and permission grants in a manifest." />
  <DocCard href="/docs/develop/extensions/plugin-runtime" title="Plugin runtime" description="Sandboxed turn hooks that run in Core." />
  <DocCard href="/docs/develop/extensions/ryu-apps" title="Author a Ryu App" description="Build an in-chat widget with defineApp." />
  <DocCard href="/docs/develop/extensions/capability-broker" title="Capability broker" description="Provide and require abstract capabilities." />
  <DocCard href="/docs/develop/extensions/desktop-companion" title="Desktop companions" description="Contribute desktop UI from a manifest." />
