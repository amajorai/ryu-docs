...
The repository example is [`examples/support-widget`](https://github.com/amajorai/ryu-sdk/tree/main/examples/support-widget).
...
Continue with [Extensions](/docs/extend/develop/extensions), [inline widgets](/docs/extend/develop/extensions/inline-widget), and [Ryu UI](/docs/ui).
