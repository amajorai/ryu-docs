...
<Callout type="info">
  ...
  a `contributes.dock_panels` entry, or a `contributes.sidebar_sections` entry — and as a plugin
  otherwise. A dual-tagged repo with no readable manifest stays an app.
</Callout>
