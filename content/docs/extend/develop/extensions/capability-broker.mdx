...
|---|---|---|
| `rag` | `@ryu/rag` | Embedding, vector storage, retrieval |
...
inventing a tab or screenshot. Exa and Parallel preserve free-search MCP errors;
...
correct the configuration or retry deliberately.
