...
[Monitors](/docs/surfaces/desktop/productivity/monitors). This page documents the engine internals.
...
| `spider` | The Spider crawler via `mcp.call_tool("spider.crawl", ...)` | For sites that need a real crawl |
