...
[/docs/surfaces/desktop/productivity/meetings](/docs/surfaces/desktop/productivity/meetings).
...
There is no streaming Voice Recognition. Each ~20 second WAV chunk Shadow posts to `POST /api/meetings/:id/chunk`
