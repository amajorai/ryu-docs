...
tags: ["Automation"]
catalog: {"kind":"plugin","id":"@ryu/agent-comms","category":"Automation","version":"0.1.14","official":true,"builtIn":false,"system":false,"preInstalled":false,"stability":"experimental","hidden":false,"surfaces":{"gateway":"none","core":"full","desktop":"full","island":"limited","mobile":"limited","extension":"limited","web":"full","cli":"full"}}
---
...
Each message id is `m` plus a node-wide monotonic sequence allocated with a
compare-and-set loop. The returned `id` and the `seq` carried in the inbox stay
stable across retries and concurrent sends.
