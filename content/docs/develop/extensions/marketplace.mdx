...
Publishing a **prerelease** version (`1.5.0-beta.1`) is the same command, and it does not disturb
your stable listing: it lands on that version's own release train, which users opt into. See
[Release Channels](/docs/develop/extensions/release-channels).
