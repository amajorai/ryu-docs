...
[Marketplace](/docs/develop/extensions/marketplace) for the listing, pricing and signing story, and
[GitHub topic discovery](/docs/develop/extensions/github-topic-discovery) for the free index.
