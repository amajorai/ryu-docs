...
## Official apps and system examples

Ryu publishes official apps you can study as examples. Only system apps are embedded in the
runtime; ordinary official apps are installed from the signed marketplace package:
...
<Quiz
  questions={[
    ...
    },
    {
      ...
      answer: 0,
      explain:
        "Ghost and Shadow are system apps; Spider is an official marketplace package. All use the same manifest and lifecycle you just used.",
    },
  ]}
/>
