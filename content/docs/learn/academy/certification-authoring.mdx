...
Badge images must use the canonical uploaded URL for that certification. URLs with path traversal, encoded path changes, query parameters, or fragments are rejected; a badge cannot point at another certification’s image.
