...
**Ryu Hire** are standalone services that can also plug into the workspace. **Ryu Platform** is the developer layer. **Ryu Apps**
...
[Ryu Notify](https://ryuhq.com/products/notify), [Ryu Hire](https://ryuhq.com/products/hire), and
