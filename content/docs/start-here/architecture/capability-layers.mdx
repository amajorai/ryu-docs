...
<Callout type="info" title="Looking for a specific primitive?">
  Each package now has its own page under **[Primitives](/docs/primitives)** — the swappable
  building blocks, one per page, grouped by what they do.
</Callout>
...
pattern, because latency matters more than isolation here.
