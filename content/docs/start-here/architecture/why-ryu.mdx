---
title: "Why Ryu"
description: "Ryu locks you to nothing: every model, engine, and strategy is a swappable default. The control layer and the principles behind it."
---
...
## The whole thesis in one line: nothing hardcoded, everything swappable
...
<Callout type="info">
The local-first principle is load-bearing for the governance layer, not just a nicety. On install, with no
