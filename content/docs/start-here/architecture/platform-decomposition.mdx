...
This page explains the decomposition model, the proven patterns, and the capability broker.
...
The decomposition is substantially complete: every feature app (mail, teams, research, clips,
finetune, quests, healing, monitors, dashboards, meetings, recipes) now serves its `/api/*` surface
out-of-process as a sidecar, and the remaining work sits in the Gateway, frontend, and platform
layers.
