...
not a promise that hosted model usage has no cost; use the [standalone Core download](https://ryuhq.com/download/core)
on a computer when local execution is the goal.
