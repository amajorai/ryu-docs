...
| Browser app | Desktop-shell wrapper plus waitlist-gated account sign-in, local Core preference, Cloud access, and browser navigation |
...
Continue with [desktop surface](/docs/surfaces/desktop), [Mobile](/docs/mobile), [web app](/docs/surfaces/webapp), [Browser extension](/docs/browser-extension), and [Core](/docs/core).
