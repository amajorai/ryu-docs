...
Continue with [Desktop user guide](/docs/surfaces/desktop/user-guide), [Identity Vault](/docs/core/identity-vault), [Gateway governance](/docs/gateway/governance), [authentication and pairing](/docs/security/authentication-and-pairing), and [Desktop account security](/docs/surfaces/desktop/user-guide/account-security).
