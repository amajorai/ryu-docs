...
## Computer and sandbox actions

Bot does not weaken computer-access or sandbox security. Pi and Core continue to enforce the
...
Pi, sandbox, and computer-access runtime. The sidebar product lockup shows Bot by default. For a
