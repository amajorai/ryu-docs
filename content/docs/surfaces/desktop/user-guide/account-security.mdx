...
description: "Google One Tap, passkeys, two-factor authentication, and backup codes — convenient sign-in with recovery safeguards."
---

Ryu accounts can use a **passkey** for passwordless sign-in and can be protected with **two-factor authentication (2FA)** using any TOTP authenticator app
...
chooser. Select the account first, then select the node (computer or cloud workspace) to connect to.
