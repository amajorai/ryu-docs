...
At the end of setup, Ryu can suggest apps based on the work you connect. It can
also draft your first task.

Ryu may offer setup quests. Each new eligible app connection earns **$0.50** in
Ryu Fast bonus credits, up to **$10**. Existing connections do not earn a second
bonus.

The desktop offer is **$50 for the first month**. It is **$250/month from month
two onward** at the five-seat Teams minimum. Existing subscribers can skip
checkout. Otherwise, Ryu confirms payment before it creates the task. If you
cancel checkout, no task starts.

The owner or an admin must start this setup for a personal, self-hosted, or
managed workspace. Members on a shared node use the workspace owner's path.
