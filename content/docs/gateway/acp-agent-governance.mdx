...
Ryu governs an ACP agent in **four independent layers**. Understanding which layer covers what is
the difference between believing an agent is governed and knowing it.
...
This is the layer people assume is missing. It is not.
...
Crucially this covers file mutation, not just shell commands: native coding agents edit through
