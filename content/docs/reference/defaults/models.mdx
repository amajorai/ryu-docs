...
| Tool and Agent Skill discovery selector | Needle 2 (`cactus-needle` runtime) | `tools.active_ranker` (`bm25` or `semantic` opt out) |
...
| sd.cpp | `sd_xl_base_1.0_0_Q4_K.gguf` | 8083 | Image generation |
